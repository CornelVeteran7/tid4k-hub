...
{ path: '/atelier', label: 'Atelier & Programări', icon: Wrench, roles: ['profesor', 'director', 'administrator'], verticals: ['workshops'] },
{ path: '/bloc', label: 'Administrare Bloc', icon: Building2, roles: ['profesor', 'director', 'administrator'], verticals: ['living'] },
...
{ path: '/spectacole', label: 'Spectacole', icon: Theater, roles: ['profesor', 'director', 'administrator'], verticals: ['culture'] },
...
{ path: '/coada', label: 'Gestionare Coadă', icon: Ticket, roles: ['secretara', 'profesor', 'director', 'administrator'], verticals: ['medicine', 'students'] },
